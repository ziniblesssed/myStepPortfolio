...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void everyAttendeeIsConsideredIncludingOptionalBusyAllDay() {
    // If optional Attendee event cancels time, ignore optional Attendee
    //
    // Events           :       |--A--|     |--B--|
    // Events(Optional) : |--------------C--------------|
    // Day              : |-----------------------------|
  ...
  @Test
  public void everyAttendeeIsConsideredIncludingOptionalPartiallyBusy() {
    // Consider optional Attendee and return available time
    //
    // Events           :       |--A--|     |--B--|
    // Events(Optional) :             |--C--|
    // Day              : |-----------------------------|
  ...
  @Test
  public void notEnoughRoomIfOptionalIsIncluded() {
    //Ignore optional Attendee since it will result in smaller time slot
    // Events           : |--A--|     |----A----|
    // Events(Optional) :       |-B-|
    // Day              : |---------------------|
    // Options          :       |-----|
  ...
  @Test
  public void optionalWithGaps() {
      //Return the gaps from the optional Attendee schedule
      // Events (Optional)  : |--A--| 
      //                                   |--B--|
      // Day                : |--------------------------|
      // Options            :        |-----|      |------|
  ...
  @Test
  public void optionalWithoutGaps() {
      //Return the gaps from the optional Attendee schedule
      // Events (Optional)  : |--A--| 
      //                            |-----------B--|
      // Day                : |--------------------|
